package browser
{
	...
	public class Wheel extends MovieClip
	{
		...
		protected function positioning(itemIn)
		{
			...
			// Muss nach echter Textgröße ausgerichtet sein !!!
			var txt = filebrowser.addText( theItem.getName() );
			txt.x = Math.cos(radians) * radiusTxt - main.getItemSize()/2;   
			txt.y = Math.sin(radians) * radiusTxt - main.getFontSize()/2;
			theItem.addText(txt);
