...
//			}
		...
		private function createStylesheet():void
		{
			var xmlContent:String = "<![CDATA[ .TextField{font:" + this.getFont("normal") + "; color:" + this.getIconColor() + "; fontSize:" + this.getFontSize() + ";} #demoStyle{} #demoStyle #demoStyle2{} #demoStyle #demoTextFieldFactroy{} #demoStyle #demoInlineStyleSheet{styleSheet:p,h1;} p{} h1{fontFace:bold; fontSize:" + (this.getFontSize()+2) + ";} ]]>";
			css = <css>{xmlContent}</css>;
		}
...
//        }
		...
		public function getFont(weightStyle:String):String
		{
			switch(weightStyle)
			{	
				case "normal":
					return "FrutigerLTStd-Roman";
				break;
				
				case "bold":
					return "FrutigerLTStd-Bold";
				break;
				
				case "italic":
					return "FrutigerLTStd-Italic";
				break;
				
				case "light":
					return "FrutigerLTStd-Light";
					break;
		...
		public function getStyleSheet():IStyleSheet
		{
